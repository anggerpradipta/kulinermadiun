...
const precacheResources = [
  ...
  'images/kuliner/9.jpg',
  'images/kuliner/10.jpg',
  'images/kuliner/11.jpg',
  'images/kuliner/12.jpg',
  'images/kuliner/user.png'
];

self.addEventListener('install', event => {
  console.log('angger-sw install event!');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('angger-sw activate event!');
});
